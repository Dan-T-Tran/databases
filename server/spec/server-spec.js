...
describe('Persistent Node Chat Server', () => {
  ...
  it('Should output all messages from the DB', (done) => {
    ...
    // Let's insert a message into the db
       const queryString = 'INSERT INTO messages (content, roomname) VALUES (?, ?)';
       const queryArgs = [text, roomname]; //can be used to fill in variables in queryString
    ...
    dbConnection.query(queryString, queryArgs, (err) => {
      ...
      axios.get(`${API_URL}/messages`)
        .then((response) => {
          ...
          console.log('SECOND SECOND ===> :', + messageLog);
          expect(messageLog[0].content).toEqual(text);
